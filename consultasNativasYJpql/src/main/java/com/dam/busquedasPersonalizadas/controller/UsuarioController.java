...
public class UsuarioController {
    ...
    @GetMapping("/buscar-native/{username}")
    public String buscarUsuarioNative(@PathVariable String username , Model model){

        Usuario usuario = usuarioService.buscarUsuarioNative(username);
    ...
    @GetMapping("/buscar-por-edad-jpql/{edad}")
    public String buscarUsuarioNative(@PathVariable Integer edad , Model model){

        Usuario usuario = usuarioService.buscarPorEdadJpql(edad);
